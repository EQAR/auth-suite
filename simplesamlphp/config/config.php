...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => getenv_docker('SSP_BASE_URL'),
     ...
     * root directory.
     */
    'certdir' => '/var/lib/simplesamlphp/cert/',
    ...
    'attributenamemapdir' => '/opt/simplesamlphp/attributemap/',
     ...
     */
    'technicalcontact_name' => getenv_docker('SSP_ADMIN_NAME', 'Administrator'),
    'technicalcontact_email' => getenv_docker('SSP_ADMIN_EMAIL', 'admin@example.com'),
     ...
     */
    'sendmail_from' => getenv_docker('SSP_FROM_EMAIL', 'no-reply@example.com'),
     ...
     */
    'secretsalt' => getenv_docker('SSP_SECRET_SALT'),
     ...
     */
    'auth.adminpassword' => getenv_docker('SSP_ADMIN_PASSWORD'),
     ...
     */
    'theme.use' => getenv_docker('SSP_THEME', 'default'),
    'theme.header' => getenv_docker('SSP_ORG_DISPLAY') . ' Single Sign-On',
    'usenewui' => true,
