...
generate_config '$LDAP_SUFFIX $KRB_REALM $REALM_NAME $LDAPCHERRY_URL $LDAPCHERRY_MAILFROM $LDAPCHERRY_PARENT_DN $LDAPCHERRY_ADMIN_GROUP_DN $LDAPCHERRY_LOGLEVEL $SMTP_HOST $SMTP_PORT'
